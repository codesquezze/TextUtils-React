        ...
        <>
            <div className="container" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}> <h1>{props.heading}</h1>
                <div className="mb-3">
                    ...
                    <textarea className="form-control" style={{ backgroundColor: props.mode === 'dark' ? 'grey' : 'white', color: props.mode === 'dark' ? 'white' : 'black' }} id="mybox" rows="3" value={text} onChange={handleOnChange}></textarea>
                </div>
                ...
                <button className="btn btn-primary mx-2" onClick={alternatingCaseClick} >Alternating Case</button>
            ...
            <div className="container my-4 " style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                ...
                <b><p>Your textarea has {word} words and {text.length} characters </p></b>
